...
using namespace cv;
using namespace std;
const char* directoryName="D:\\VTKproj\\imageCheck\\steps\\";
...
void processEroDia2(IplImage* image)
{
	...
	images[0]=processEroDia1(image,4,1);//cvSaveImage(getFilePath("cv_2.1.bmp"),image1);
	images[1]=processEroDia1(image,6,5);//cvSaveImage(getFilePath("cv_2.2.bmp"),image2);
...
{
	//equalizeHis(image);//cvSaveImage(getFilePath("cv_1.1.bmp"),image);
	...
	//bwareaopen(image,10);//cvSaveImage("C:\\Users\\Chnhideyoshi\\Desktop\\steps\\cv_3.5.bmp",image);
}
